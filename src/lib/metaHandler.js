...
function homeHeaderModelHandler(meta, corpId) {
    ...
    _meta.attendanceUrl = 'https://attend.dingtalk.com/attend/index.html?dd_web_timestamp='+(new Date().getTime())+'&showmenu=false&dd_share=false&corpId=dingf8bfabd87f8ad90f&swfrom=work_homepage#stat';
    _meta.myTasksUrl = 'https://aflow.dingtalk.com/dingtalk/mobile/homepage.htm?corpid=dingf8bfabd87f8ad90f&showmenu=false&dd_share=false&swfrom=work_homepage#upcoming';
    _meta.checkinsUrl = 'https://attendance.dingtalk.com/attendance/mobile/mapAttendance.html?corpid=dingf8bfabd87f8ad90f&showmenu=false&dd_progress=false&dd_share=false&swfrom=work_homepage&to_page=footprint';
    _meta.notReadReportUrl = 'https://landray.dingtalkapps.com/alid/app/report/received_new.html?corpid=dingf8bfabd87f8ad90f&ismy=2&dd_share=false&readType=1&swfrom=work_homepage';
    return _meta;
}
